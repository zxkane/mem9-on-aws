...
| Container registry | Four production and four preview ECR repositories under `mem9-on-aws/*`, plus guarded registry-level BASIC scanning, managed out of band                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
- `scripts/` — out-of-band bootstrap scripts (GitHub Actions IAM role, workload
  permissions boundary, isolated production/preview ECR repositories, guarded registry scan-on-push,
