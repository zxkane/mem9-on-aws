...
| TC-DOCS-003 | Database path | `mnemo-server` and the bootstrap task use the Aurora cluster writer endpoint directly with a Secrets Manager credential. RDS Proxy is outside the current architecture. |
