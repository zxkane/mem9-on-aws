...
| TC-INGEST-ATOMIC-039 | ECS deploys an enabled replacement | Entrypoint migration completes before the server/worker starts; CI performs exactly one service rollout and then the complete bootstrap |
