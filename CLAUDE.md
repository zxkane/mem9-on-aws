...
| Auth | **Cognito M2M**, reusing the podcast-curation / llm-wiki gateway pattern |
...
1. Embedding supply concrete shape: reuse llm-wiki's deployed qwen3 query Lambda
...
4. Gateway target style: REST/OpenAPI (podcast-curation style, mnemo-server is a
